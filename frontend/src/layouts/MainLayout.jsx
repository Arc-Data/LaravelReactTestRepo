        ...
        <> 
            ...
            <div className="container mx-auto mt-12 grid md:grid-cols-[200px,auto] bg-background py-12" > 
                <div className="hidden gap-2 px-2 text-lg border-r md:flex md:flex-col border-slate-900">
                    <nav className="flex flex-col gap-2 md:sticky md:top-28">
                        <div className="flex items-center gap-4 px-6 py-2 border border-slate-800 text-md rounded-xl" onClick={() => {
                            navigate('/')
                            window.scrollTo(0, 0)
                        }}>
                        ...
                        <div to="/" className="flex items-center gap-4 px-6 py-2 border border-slate-800 text-md rounded-xl" onClick={() => {
                            navigate('/?type=all')
                            window.scrollTo(0, 0)
                        }}>
